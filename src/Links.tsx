        ...
        <div className="parent-links">
          ...
          <div className="div4-l">
            ...
            <p className="clique-p">
              my seasons is{" "}
              <a href="https://cliques.shadow-lord.com/seasons" target="_blank">
                autumn
              </a>{" "}
              <img src="cliques/fall.png" alt="fall" />
            </p>
            <p className="clique-p">
              married to{" "}
            ...
            <p className="clique-p">
              my favorite hot bevarage is{" "}
              <a href="https://cliques.shadow-lord.com/hot" target="_blank">
                green tea
              </a>
            </p>
